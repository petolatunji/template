      ...
      <div className='flex '>
        <div className='flex flex-col px-6 py-4 w-[75%] '>
          ...
          <div className='flex flex-col mt-6'>
            <input
              placeholder='Which softwares are good to get started with basic UI design'
              type='text'
            ...
            <div className='flex items-center gap-16 '>
              <div className='flex flex-col'>
                ...
                <input
                  ...
                  type='text'
                  className='border my-1 w-[200px] p-2 bg-inherit border-yellow-400 focus:outline-none'
                />
              </div>
              <div className='flex flex-col'>
        ...
        <div className='  mt-10 shadow-md bg-white p-4 mr-6 flex  flex-col '>
          <h1 className='font-bold text-xs'>QUESTIONS LIST</h1>
          <hr className='mt-2' />
          <div className='flex flex-col'>
            <p className=' my-4 font-bold px-4 py-1  text-[10px] text-gray-600 rounded-full border flex items-center gap-x-2 border-yellow-300 bg-yellow-50 '>
