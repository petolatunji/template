      ...
      <div className='flex '>
        <div className='flex flex-col px-6 py-4 w-[75%] '>
          ...
          <div className='flex flex-col mt-6'>
            <input
              placeholder='Rate me in communication skills'
              type='text'
            ...
            <div className='flex flex-wrap gap-4 mt-4'>
              <div className='flex flex-col items-center border border-yellow-400 p-4 rounded-md'>
                <BsFillStarFill className='text-4xl text-yellow-400' />
                <p className='mt-2'>One</p>
              </div>
              <div className='flex flex-col items-center border border-yellow-400 p-4 rounded-md'>
                <BsFillStarFill className='text-4xl text-yellow-400' />
                <p className='mt-2'>Two</p>
              </div>
              <div className='flex flex-col items-center border border-yellow-400 p-4 rounded-md'>
                <BsFillStarFill className='text-4xl text-yellow-400' />
                <p className='mt-2'>Three</p>
              </div>
              <div className='flex flex-col items-center border border-yellow-400 p-4 rounded-md'>
                <BsFillStarFill className='text-4xl text-yellow-400' />
                <p className='mt-2'>Four</p>
              </div>
              <div className='flex flex-col items-center border border-yellow-400 p-4 rounded-md'>
                <BsFillStarFill className='text-4xl text-yellow-400' />
                <p className='mt-2'>Five</p>
              </div>
            </div>
          </div>
        </div>
