      ...
      <div className='flex '>
        <div className='flex flex-col px-6 py-4 w-[75%] '>
          <div className='flex items-center justify-between mt-10'>
            ...
            <div class='custom-select w-[200px]'>
              <select class='border-0 cursor-pointer p-2  bg-sky-200 w-[150px] duration-300 hover:bg-sky-400 border-yellow-400 '>
                <option value='0'>Emoji Rating</option>
          ...
          <div className='flex flex-col mt-6'>
            <input
              placeholder='How good am I in Adobe Photoshop?'
              type='text'
            ...
            <div className='flex flex-wrap gap-4 mt-4'>
              <div className='flex flex-col items-center border border-yellow-400 p-4 rounded-md'>
                <BsEmojiAngry className='text-4xl text-yellow-400' />
                <p className='mt-2'>Terrible</p>
              </div>
              <div className='flex flex-col items-center border border-yellow-400 p-4 rounded-md'>
                <BsEmojiHeartEyes className='text-4xl text-yellow-400' />
                <p className='mt-2'>Bad</p>
              </div>
              <div className='flex flex-col items-center border border-yellow-400 p-4 rounded-md'>
                <BsFillEmojiHeartEyesFill className='text-4xl text-yellow-400' />
                <p className='mt-2'>Okay</p>
              </div>
              <div className='flex flex-col items-center border border-yellow-400 p-4 rounded-md'>
                <BsEmojiSunglasses className='text-4xl text-yellow-400' />
                <p className='mt-2'>Good</p>
              </div>
              <div className='flex flex-col items-center border border-yellow-400 p-4 rounded-md'>
                <BsFillEmojiKissFill className='text-4xl text-yellow-400' />
                <p className='mt-2'>Great</p>
              </div>
            </div>
          </div>
        </div>
